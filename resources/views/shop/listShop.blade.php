        ...
        function getShopList(url){
			...
			success: function(data) {
				if(data.status == true) {
                    ...
                    $('#allShop').html('<h6 class="text-danger">Unable to fetch data! Something went wrong!</h6>');
